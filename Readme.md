# K2 plus 3DO nozzle cam

NOTE: this has only been tested with the k2 PLUS, I have no way to test on a k2 or k2 pro.
...
```
find /mnt/UDISK -name uninstaller.sh -path "*k2-nozzlecam-main*" -exec sh {} \; 2>/dev/null
```
